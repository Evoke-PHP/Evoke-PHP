...
/** The Join Tree class is used to interact with Relational Databases.
 ...
 */
class JoinTree implements Iface\DB\Table\Joins
{
	/** @property $childField
		...
		Array               $joins          = array())
	{
		...
		{
			if (!$join instanceof JoinTree)
			{
				throw new \InvalidArgumentException(
					__METHOD__ . ' all joins must be a JoinTree');
			}
		}

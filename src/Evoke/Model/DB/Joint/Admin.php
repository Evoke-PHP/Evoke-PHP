...
class Model_DB_Joint_Admin extends Model_DB_Joint
implements \Evoke\Iface\Model_Admin
{
   protected $failures;
   ...
   public function __construct(Array $setup)
   {
	 ...
	 throw new \InvalidArgumentException(
      ...
      if (!$this->setup['Table_List_ID'] instanceof DB\Table_List_ID)
      {
	 throw new \InvalidArgumentException(
	    __METHOD__ . ' requires Table_List_ID');
      }

 ...
 * HTTP Response
 *
 * The HTTP Response as per RFC2616 and to a lesser extent RFC1945.  Links in this documentation will generally refer to
 * RFC2616.
 *
 * It is important to understand that PHP is generally run as mod_php or under a similar environment where the HTTP
 * response headers are calculated automatically.
 *
...
class Response implements ResponseIface
{
     ...
     *
     * @throws LogicException If the headers has already been sent or the response code isn't set.
     */
     ...
     *
     * The valid header fields are defined in RFC2616 sections 4.5, 6.2, 7.1. (Note: 7.1 extension-header allows for the
     * wide range of headers that we match here, even though they may be ignored by clients.)
     *
    ...
    /**
     * Get the status reason for the status code, defaulting to HTTP 1.1 recommendations.
     *

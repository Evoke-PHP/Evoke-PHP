...
use Evoke\Network\URI\Router\Rule\RegexNamed;
use PHPUnit_Framework_TestCase;

/**
 * @covers Evoke\Network\URI\Router\Rule\RegexNamed
...
class RegexNamedTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('Evoke\Network\URI\Router\Rule\RegexNamed', $object);
    }

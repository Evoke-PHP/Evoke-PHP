...
class DataBuilderTest extends PHPUnit_Framework_TestCase
{
	...
	public function providerBuild()
	{
		...
		$trunk
			...
			->method('getJoins')
			->with()
			->will($this->returnValue(['Branch_1'   => $branch1,
			                           'Branch_2'   => $branch2,
		...
		$dataBranchAll = new Data($branchAll, ['Leaf_1' => $dataLeaf1,
		                                       'Leaf_2' => $dataLeaf2]);
		$dataTrunk = new Data($trunk, ['Branch_1'   => $dataBranch1,
